...
const firstNumber = Math.floor(Math.random() * 94)
...
class App extends React.Component {
  ...
  random = () => {
      let randomColor = Math.floor(Math.random()*256).toString();
      document.body.style.backgroundColor = 'rgb' + '(' + randomColor + ',' + randomColor + ',' + 0 + ')';
      document.body.querySelector('div').style.color = 'rgb' + '(' + randomColor + ',' + 0 + ',' + randomColor + ')';
      document.body.querySelector('button').style.backgroundColor = 'rgb' + '(' + randomColor + ',' + 0 + ',' + randomColor + ')';
